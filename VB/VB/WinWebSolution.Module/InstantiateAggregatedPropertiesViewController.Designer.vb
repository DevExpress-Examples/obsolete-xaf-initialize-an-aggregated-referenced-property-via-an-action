...
Namespace WinWebSolution.Module
	Partial Public Class InstantiateAggregatedPropertiesViewController
		...
		Private Sub InitializeComponent()
			...
			' simpleAction1
			' 
			Me.simpleAction1.Caption = "InstantiateReadOnlyAddressViaController"
...
'			Me.simpleAction1.Execute += New DevExpress.ExpressApp.Actions.SimpleActionExecuteEventHandler(Me.simpleAction1_Execute);
			...
			' simpleAction2
			' 
			Me.simpleAction2.Caption = "InstantiateWritableAddressViaController"
			...
			Me.simpleAction2.TargetObjectType = GetType(WinWebSolution.Module.TestAggregatedPropertiesObject)
